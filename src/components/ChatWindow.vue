  ...
  <div class="app-layout">
    <div class="sidebar">
      <div class="logo-section">
        <img src="@/assets/18.png" alt="sm" width="160" height="160" />
        <span class="logo-text">神医圣手孙默（SuperMax版）</span>
      </div>
        ...
        .post(
            ...
            { memoryId: uuid.value, message },
            {
                ...
                onDownloadProgress: (e) => {
                    ...
                    // 只添加新内容部分
                    const newText = processedText.substring(lastMsg.content.length);
